...
//            CommandContainer commandContainer = new CommandContainer(client.getLogin(), client.isAgent(), messageWeb.getMsg());
...
//            if (client.isAgent()) {
//                if (client.getRecipient() != null) {
//                    for (User receipt : (List<User>) client.getRecipients()) {
...
//            } else {
//                if (client.getRecipient() != null) {
//                    client.getRecipient().getSocket().send(new CommandContainer(AnswerCode.CLIENT_LEAVE, client.getLogin()));
